...
async def collect_data(config):
    ...
    # --- 2. NEWS DATA (Intelligent, Independent Logic) ---
    ...
    # --- 3. TWEET DATA (Intelligent, Independent Logic) ---
    #commented out, handeled by standalone tweetscraper.py
    ...
    #        else:
    #            tweet_since_date = (last_tweet_date + timedelta(days=1)).strftime('%Y-%m-%d')
    #else:
